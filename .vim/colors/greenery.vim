...
if &t_Co > 255
   ...
   hi Constant        ctermfg=83                cterm=bold
   ...
   hi Keyword         ctermfg=210               cterm=bold
   hi Label           ctermfg=210               cterm=none
   hi Macro           ctermfg=114
   hi SpecialKey      ctermfg=81

   hi MatchParen      ctermfg=16  ctermbg=81    cterm=bold
   ...
   hi Repeat          ctermfg=81                cterm=bold
   hi Search          ctermfg=253 ctermbg=66

   " marks column
   hi SignColumn      ctermfg=118 ctermbg=235
   hi SpecialChar     ctermfg=127               cterm=bold
   hi SpecialComment  ctermfg=245               cterm=bold
   hi Special         ctermfg=127
   hi SpecialKey      ctermfg=127

   hi Statement       ctermfg=81                cterm=bold
   hi StatusLine      ctermfg=238 ctermbg=253
   hi StatusLineNC    ctermfg=244 ctermbg=232
   hi StorageClass    ctermfg=48
   hi Structure       ctermfg=47
   hi Tag             ctermfg=161
   hi Title           ctermfg=166
   hi Todo            ctermfg=231 ctermbg=232   cterm=bold

   hi Typedef         ctermfg=47
