...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "web", "prog", "doc", "media", "word", "mail", "p2p", "term", "misc" }, s, layouts[1])
end
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "m",      function () awful.util.spawn(termexec .. "scmus") end),
    ...
    awful.key({ modkey, "Control" }, ".",      function () awful.util.spawn("mpc seek +60") end),
    awful.key({ modkey, "Control" }, ",",      function () awful.util.spawn("mpc seek -60") end),
